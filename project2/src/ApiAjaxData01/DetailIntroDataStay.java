...
public class DetailIntroDataStay {
	 ...
	 //public static void main(String args[]){	
		...
		try {
			...
			urlBuilder.append("&contentTypeId=32");// stay=32, 
	        ...
	        String keyString[] = {"accomcountlodging", "barbecue", "beauty", "benikia", "beverage",
	        		"bicycle", "campfire", "checkintime", "checkouttime", "chkcooking", "contentid",
	        		"contenttypeid", "fitness", "foodplace", "goodstay", "hanok", "infocenterlodging",
	        		"karaoke", "parkinglodging", "pickup", "publicbath", "publicpc", "reservationlodging",
	        		"reservationurl", "roomcount", "roomtype", "sauna", "seminar", "sports", "subfacility"};
	        ...
	        String sql = "insert into stayIntroTbl values ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? , "
	        		+ " ? , ?  , ? , ? , ?, ?, ?, ?, ?, ?, ?, ?, ? , ? , ?,  ? )";
	        ...
	        System.out.println("DetailIntroDataStay	success");
