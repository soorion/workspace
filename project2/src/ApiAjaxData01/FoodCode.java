...
public class FoodCode {
	...
	public void foodDataGet(String serviceKey, String aCode, String mobileOs, String mobileApp, 
	 ...
	 // public static void main(String args[]){	
		...
		System.out.println("end	FoodCode" + aCode);
