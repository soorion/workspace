...
public class StayCode {
  	
	public void stayDataGet(String serviceKey, String aCode, String mobileOs, String mobileApp,
	 ...
	 // public static void main(String args[]){	
		...
		try {
	        ...
	        String sql = "insert into stayTbl values ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, "
	        		+ "?, ?, ?, ?, ?, ?)";
		...
		System.out.println("end	stayCode" + aCode);
